...
# 60 "../../../Library/StdDriver/src/clk.c"
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
...
# 80 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_PowerDown(void)
{
...
# 121 "../../../Library/StdDriver/src/clk.c"
void CLK_Idle(void)
{
...
# 264 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetPLLClockFreq(void)
{
    uint32_t u32PllFreq;
    uint32_t u32Reg;
...
# 316 "../../../Library/StdDriver/src/clk.c"
void CLK_DisablePLL(void)
{
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PLLCTL |= (0x1ul << (16));
}
# 333 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
...
# 521 "../../../Library/StdDriver/src/clk.c"
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
...
# 556 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
...
# 704 "../../../Library/StdDriver/src/clk.c"
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
...
# 898 "../../../Library/StdDriver/src/clk.c"
void CLK_DisableModuleClock(uint32_t u32ModuleIdx)
{
    const uint32_t au32ClkTbl[3] = {0x0UL, 0x4UL, 0x8UL};
...
# 919 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
...
# 951 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockDisable(uint32_t u32ClkMask)
{
    uint32_t u32TimeOutCnt = SystemCoreClock;
...
# 983 "../../../Library/StdDriver/src/clk.c"
void CLK_EnableSysTick(uint32_t u32ClkSrc, uint32_t u32Count)
{
...
# 1270 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockDivider(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL;

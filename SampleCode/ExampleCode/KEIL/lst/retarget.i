...
# 105 "../../../Library/StdDriver/src/retarget.c"
static void DumpStack(uint32_t stack[])
{
# 117 "../../../Library/StdDriver/src/retarget.c"
}
# 176 "../../../Library/StdDriver/src/retarget.c"
int32_t SH_Return(int32_t n32In_R0, int32_t n32In_R1, int32_t *pn32Out_R0);
int32_t SH_Return(int32_t n32In_R0, int32_t n32In_R1, int32_t *pn32Out_R0)
{
    return 0;
}
# 189 "../../../Library/StdDriver/src/retarget.c"
    __attribute__((weak))
...
uint32_t ProcessHardFault(uint32_t lr, uint32_t msp, uint32_t psp)
{
    uint32_t *sp;
    uint32_t inst;
# 207 "../../../Library/StdDriver/src/retarget.c"
        if (lr & 4UL)
        {
            sp = (uint32_t *)psp;
        }
...
# 230 "../../../Library/StdDriver/src/retarget.c"
    inst = (*((vu16 *) (sp[6])));
...
# 263 "../../../Library/StdDriver/src/retarget.c"
void SendChar_ToUART(int ch)
{
...
# 354 "../../../Library/StdDriver/src/retarget.c"
__attribute__((weak)) void SendChar(int ch)
{
# 387 "../../../Library/StdDriver/src/retarget.c"
    SendChar_ToUART(ch);

}
# 401 "../../../Library/StdDriver/src/retarget.c"
char GetChar(void)
{
# 452 "../../../Library/StdDriver/src/retarget.c"
    while (1)
    {
...
# 474 "../../../Library/StdDriver/src/retarget.c"
int kbhit(void)
{
    return !((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (14))) == 0U);
}
# 490 "../../../Library/StdDriver/src/retarget.c"
int IsDebugFifoEmpty(void)
{
    return ((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (28))) != 0U);
}
# 505 "../../../Library/StdDriver/src/retarget.c"
void _ttywrch(int ch)
{
    SendChar(ch);
    return;
}
# 560 "../../../Library/StdDriver/src/retarget.c"
int fputc(int ch, FILE *stream)
{
    SendChar(ch);
    return ch;
}
# 652 "../../../Library/StdDriver/src/retarget.c"
int fgetc(FILE *stream)
{
    return ((int)GetChar());
}
# 672 "../../../Library/StdDriver/src/retarget.c"
int ferror(FILE *stream)
{
    return (-1);
}
